...
const Banner = () => {
  return (
    <>
      <section id='#home' className="grid grid-cols-1 w-[100%] justify-center items-center lg:grid-cols-2 hidden lg:grid" style={{ backgroundColor: "#f0f0f0" }}>
        <Image
        ...
        <section className="col-span-1 justify-self-center text-center">
          ...
          <p className="text-[30px] font-normal text-right">54 dias | 12 horas | 53 minutos</p>
        </section>
      </section>
      ...
      <section className="grid w-[100%] justify-center items-center lg:hidden">
        ...
        <section className="col-span-1 text-center mt-3">
          ...
          <p className="text-[20px] font-normal text-center">11 de Noviembre de 2023</p>
          <p className="text-[15px] font-normal text-center">54 dias | 12 horas | 53 minutos</p>
        </section>
      </section>
    </>
  );
