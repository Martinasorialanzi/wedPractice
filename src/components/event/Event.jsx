  ...
  return (
    <>
      <section className=" mt-10">
        ...
        <section className="grid w-[100%] justify-center items-center  ">
          <section className="  col-span-1 mt-3 ">
            <section className="mt-3 text-center ">
              ...
              />
              <p className="text-[20px] font-normal mt-1 text-center  ">
                Ceremonia
              </p>
            ...
            <section className="mt-3 text-center">
              <Image
                ...
                className="mx-auto col-span-1 justify-self-center "
              />
              <p className="text-[20px] font-normal mt-0 text-center  ">
                Fiesta
              </p>
              <p className="text-[14px] font-normal mt-1 text-center ">
