...
<section className=" mt-0">
      <section
        ...
        >
        <section className="col-span-1 justify-self-center ">
          <p className="text-[20px] font-medium  text-center mb-5 ">
            Estamos felices de compartir este día con vos
          </p>
        </section>
        <Image
    ...
    >
        ...
        <Image
          ...
          <section className="mt-10 text-center ">
            ...
            <p className="text-[14px] font-normal mt-3 text-center ">
              Iglesia Nuestra Señora del Valle 
            </p>
            <p className="text-[14px] font-normal text-center ">
              17hs
            </p>
            <button className="text-[15px] font-normal mt-3 text-center bg-[#C8C8C8] rounded-[10px] text-[#ffffff] w-[151px]">
              Como llegar
            </button>
          </section>
          <section className="mt-10 text-center" >
            <p className="text-[20px] font-normal  text-center  ">Fiesta</p>
            <p className="text-[14px] font-normal mt-3 text-center ">
            San Pablo Country Club
            </p>
            <p className="text-[14px] font-normal  text-center ">
