...
import imgSquare2 from '../../../public/Memi&Jose/mjBanner.png';
import imgppal from '../../../public/Memi&Jose/mjBanner.png';
...
>
      ...
      />
        <Event
          ...
          horarioFiesta="21:30hs"
          buttonClassColors={`${buttonBgColor} ${buttonTextColor} ${buttonHoverColor}`}
          textColor={textColor}
        />
       <Confirmation
        linkConfirmacion="https://forms.gle/QrxyumvnekitAGuq7"
        buttonClassColors={`${buttonBgColor} ${buttonTextColor} ${buttonHoverColor}`}
        textColor={textColor}
